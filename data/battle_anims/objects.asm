...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_07, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS ; ANIM_OBJ_BIG_ICE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_07, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROCKS ; ANIM_OBJ_SMALL_ICE
