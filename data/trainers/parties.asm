...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, IRON_HEAD, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, IRON_HEAD, THUNDER_WAVE
...
Rival1Group:
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, THUNDER_WAVE
	...
	db 35, MAGNETON,   THUNDERSHOCK, IRON_HEAD, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, DRAGON_PULSE
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERSHOCK, IRON_HEAD, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, DRAGON_PULSE
...
WillGroup:
	...
	db 40, XATU,       QUICK_ATTACK, DRAGON_PULSE, CONFUSE_RAY, PSYCHIC_M
	db 41, JYNX,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, DRAGON_PULSE, PSYCHIC_M
	db 41, SLOWBRO,    CURSE, AMNESIA, BODY_SLAM, PSYCHIC_M
	db 42, XATU,       QUICK_ATTACK, DRAGON_PULSE, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
ChampionGroup:
	...
	db 44, GYARADOS,   CRUNCH, RAIN_DANCE, WATERFALL, OUTRAGE
...
BrockGroup:
	...
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, THRASH
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	; db 44, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 44, ONIX,       CRUNCH, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
...
ErikaGroup:
	...
	db 42, TANGELA,    VINE_WHIP, LEECH_SEED, GIGA_DRAIN, SLEEP_POWDER
...
SchoolboyGroup:
	...
	db 35, ELECTRODE,  SCREECH, THUNDERSHOCK, ROLLOUT, LIGHT_SCREEN
	...
	db 35, XATU,       PECK, NIGHT_SHADE, SWIFT, DRAGON_PULSE
	db 32, TANGELA,    POISONPOWDER, VINE_WHIP, LEECH_SEED, MEGA_DRAIN
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, BITE, SUPERSONIC
	db 35, QUAGSIRE,   TAIL_WHIP, HEADBUTT, AMNESIA, EARTHQUAKE
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 40, FARFETCH_D, FURY_ATTACK, BRAVE_BIRD, FLY, SLASH
	db -1 ; end
	...
	db 38, PIDGEOT,    SWIFT, BRAVE_BIRD, STEEL_WING, FLY
	db -1 ; end
...
JanineGroup:
	...
	db 36, WEEZING,    FLAMETHROWER, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 36, WEEZING,    FLAMETHROWER, SLUDGE_BOMB, TOXIC, EXPLOSION
...
CooltrainerMGroup:
	...
	db 35, VICTREEBEL, LEECH_SEED, TOXIC, ACID, RAZOR_LEAF
	db 35, KINGLER,    BUBBLEBEAM, STOMP, CRUNCH, PROTECT
	db 35, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FLAME_WHEEL
	db -1 ; end

	; COOLTRAINERM (7)
	db "GAVEN@", TRAINERTYPE_ITEM_MOVES
	db 39, VICTREEBEL, NO_ITEM,      GIGA_DRAIN, TOXIC, SLUDGE_BOMB, RAZOR_LEAF
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, CRUNCH, BLIZZARD
	db 39, FLAREON,    NO_ITEM,      FLAMETHROWER, QUICK_ATTACK, BITE, FLAME_WHEEL
	db -1 ; end
	...
	; COOLTRAINERM (10)
	db "GAVEN@", TRAINERTYPE_MOVES
	db 32, VICTREEBEL, LEECH_SEED, TOXIC, ACID, RAZOR_LEAF
	db 32, KINGLER,    BUBBLEBEAM, STOMP, CRUNCH, PROTECT
	db 32, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FLAME_WHEEL
	db -1 ; end

	; COOLTRAINERM (11)
	db "BLAKE@", TRAINERTYPE_MOVES
	db 33, MAGNETON,   THUNDERBOLT, SUPERSONIC, SWIFT, SCREECH
	db 31, QUAGSIRE,   WATER_GUN, HEADBUTT, AMNESIA, EARTHQUAKE
	...
	db 37, DRAGONAIR,  TWISTER, SURF, BITE, BODY_SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 36, RAPIDASH,   STOMP, FLAME_WHEEL, FURY_ATTACK, AGILITY
	db -1 ; end
	...
	; COOLTRAINERF (12)
	db "BETH@", TRAINERTYPE_MOVES
	db 39, RAPIDASH,   STOMP, FLAME_WHEEL, FURY_ATTACK, AGILITY
	db -1 ; end
	...
	db 43, RAPIDASH,   FOCUS_BAND,   STOMP, FLAME_WHEEL, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, SEISMIC_TOSS, SOFTBOILED
	db -1 ; end
...
SabrinaGroup:
	...
	db 48, ALAKAZAM,   RECOVER, DRAGON_PULSE, PSYCHIC_M, REFLECT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, POISON_STING, TWINEEDLE, RAGE
...
FisherGroup:
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, HEADBUTT, FURY_ATTACK
	db 34, SEAKING,    SUPERSONIC, WATERFALL, HEADBUTT, FURY_ATTACK
	...
	db 39, SEAKING,    ENDURE, HEADBUTT, FURY_ATTACK, WATERFALL
	db -1 ; end
...
SwimmerFGroup:
	...
	db 21, HORSEA,     ACID, SMOKESCREEN, LEER, WATER_GUN
	db 21, HORSEA,     ACID, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     WATER_GUN, LEER, BITE, HARDEN
	db 20, KRABBY,     BUBBLEBEAM, LEER, BITE, HARDEN
	db -1 ; end
...
Rival2Group:
	...
	db 43, ALAKAZAM,   DISABLE, RECOVER, DRAGON_PULSE, PSYCHIC_M
	...
	db 45, MAGNETON,   THUNDER, FLASH_CANNON, THUNDER_WAVE, SWIFT
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, DRAGON_PULSE, PSYCHIC_M, REFLECT
...
HikerGroup:
	...
	db 34, MACHOKE,    KARATE_CHOP, KARATE_CHOP, HEADBUTT, DIG
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   CURSE, ANCIENTPOWER, FLAMETHROWER, ROCK_SLIDE
	db 45, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 50, RAPIDASH,   QUICK_ATTACK, EARTHQUAKE, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
...
BurglarGroup:
	...
	db 24, KOFFING,    TACKLE, EMBER, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, MEDITATE, JUMP_KICK, THRASH
	db -1 ; end

	; BLACKBELT_T (3)
	db "KENJI@", TRAINERTYPE_MOVES
	db 33, ONIX,       BITE, ROCK_THROW, TOXIC, DIG
...
ExecutiveMGroup:
	...
	db 35, HOUNDOOM,   EMBER, DIG, BITE, FAINT_ATTACK
	db -1 ; end
	...
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, KOFFING,    TACKLE, EMBER, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PsychicGroup:
	...
	db 24, NATU,       LEER, NIGHT_SHADE, DRAGON_PULSE, CONFUSE_RAY
	db 26, KADABRA,    DISABLE, PSYBEAM, RECOVER, DRAGON_PULSE
	db -1 ; end
...
PicnickerGroup:
	...
	db 36, PONYTA,     DOUBLE_TEAM, STOMP, FLAME_WHEEL, SUNNY_DAY
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, ARBOK,      FAINT_ATTACK, POISON_STING, BITE, GLARE
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, ARBOK,      FAINT_ATTACK, LEER, POISON_STING, BITE
...
RedGroup:
	...
	db 77, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, DRAGON_PULSE
...
BlueGroup:
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, SEISMIC_TOSS, SOLARBEAM
...
GruntFGroup:
	...
	db 18, EKANS,      TACKLE, LEER, POISON_STING, BITE
...
MysticalmanGroup:
	...
	db 25, ELECTRODE,  SCREECH, BITE, THUNDER, ROLLOUT
	db -1 ; end
