...
BattleTowerMons2:
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, WATERFALL, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db AERODACTYL
	db GOLD_BERRY
	db REST, ROCK_SLIDE, EARTHQUAKE, DRAGON_CLAW
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, TOXIC, SOFTBOILED, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HITMONCHAN
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, BULLET_PUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons3:
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, ICE_PUNCH, PSYCHIC_M
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db LANTURN
	db GOLD_BERRY
	db RAIN_DANCE, THUNDER, SURF, BODY_SLAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db TENTACRUEL
	db KINGS_ROCK
	db GIGA_DRAIN, TOXIC, SLUDGE_BOMB, BUBBLEBEAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PRIMEAPE
	db MIRACLEBERRY
	db LOW_KICK, KARATE_CHOP, REVERSAL, FIRE_PUNCH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons4:
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, THUNDERPUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db OMASTAR
	db GOLD_BERRY
	db CURSE, WATER_GUN, ANCIENTPOWER, EARTH_POWER
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FLAMETHROWER, DRAGON_PULSE, FLY, SLASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons6:
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, STONE_EDGE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons8:
	...
	db MOLTRES
	db CHARCOAL
	db FLAMETHROWER, AIR_SLASH, STEEL_WING, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PINSIR
	db GOLD_BERRY
	db HYPER_BEAM, X_SCISSOR, STRENGTH, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons10:
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, EARTHQUAKE, HYPER_BEAM, FIRE_PUNCH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
